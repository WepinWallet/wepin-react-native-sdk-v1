...
@interface RCT_EXTERN_MODULE(ProviderRn, NSObject)


RCT_EXTERN_METHOD(createWepinProvider:(NSString *)appId
...
RCT_EXTERN_METHOD(getProvider:(NSString *)network
                 withResolver:(RCTPromiseResolveBlock)resolve
                 withRejecter:(RCTPromiseRejectBlock)reject)

RCT_EXTERN_METHOD(request:(NSString *)network
